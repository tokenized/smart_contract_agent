...
func ListEvents(ctx context.Context, store storage.StreamStorage) (Events, error) {
	var result Events
...
func SaveEvents(ctx context.Context, store storage.StreamStorage, events Events) error {
