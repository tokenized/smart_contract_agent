...
require (
	...
	github.com/tokenized/pkg v0.6.1-0.20230424204429-ab336b6e84a4
	github.com/tokenized/specification v1.2.1-0.20230424204707-14dcf858bdfb
	github.com/tokenized/spynode v0.3.0
